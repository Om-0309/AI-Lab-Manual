...
# 1. LOAD DATA
# =============================
CSV_PATH = r"c:\Users\samsu\Downloads\AI Lab\AI Lab\cleaned.csv"   # <-- change this to your CSV file name
...
# =============================
# 2. OPTIONAL: SUBSAMPLE (for speed) - DISABLED TO USE FULL DATASET
# =============================
# Using full dataset
...
# 3. TARGET & FEATURES
# =============================
TARGET_COL = "label"  # Using label (4 classes) instead of signature (247 classes)
...
log_model = LogisticRegression(
    ...
    n_jobs=-1,
    verbose=0,
    tol=0.01  # less strict convergence
)
