...
# 1. Load CSV
# ---------------------------------------------------
CSV_PATH = r"c:\Users\samsu\Downloads\AI Lab\AI Lab\cleaned.csv"   # change if needed
...
# ---------------------------------------------------
MAX_ROWS = 1000  # adjust based on your machine
if len(df) > MAX_ROWS:
...
# 3. Target column
# ---------------------------------------------------
TARGET = "label"  # Using label instead of signature (only 3-4 classes instead of 247)
